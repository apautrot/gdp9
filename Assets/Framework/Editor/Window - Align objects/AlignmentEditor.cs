...
// 	Texture2D destributeAlignEvenV;
	...
	static void Init ()
	{
		...
		window.titleContent = new GUIContent ( "Align Objects" );
	...
	void LoadResources()
	{
		turnLeft = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Turn left.png" );
		turnRight = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Turn right.png" );

		alignBottom = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Align-bottom.png" );
		alignTop = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Align-top.png" );
		alignLeft = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Align-left.png" );
		alignRight = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Align-right.png" );
		alignCenterH = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Align-center-h.png" );
		alignCenterV = AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Align-center-v.png" );
...
// 		destributeAlignEvenV = Resources.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Distribute-even-v.png" );
		...
		{
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-top-left.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-top.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-top-right.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-left.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-center.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-right.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-bottom-left.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-bottom.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-on-bottom-right.png" )
		};

		axisImages = new Texture[]
		{
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-top-left.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-top.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-top-right.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-left.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-center.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-right.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-bottom-left.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-bottom.png" ),
			AssetDatabase.LoadAssetAtPath<Texture2D> ( "Assets/Framework/Editor/Window - Align objects/Images/Axis-bottom-right.png" )
		};
